        ...
        <>
            <div className="main">
                ...
                <div className="search">
                    <p style={{ fontFamily: 'poppins', fontSize: '25px', margin: '0px', paddingTop: '130px', color: '#fff' }}>
                    My Art Gallery is a space to showcase your Art through sharing<br />them to your feed for the whole world to see..
                    <br />Look For Other Creatives/ Artists by Searching their usernames
                    </p>
                    <br /><br />
